    ...
    public class RegistrationTestsSteps
    {
        ...
        public void ThenTheCountrySelectionTextShouldBe(string expectedText)
        {
            Assert.Multiple(() =>
            {
                ...
                Assert.That(_mainPage.SelectCountryTextEnabled, Is.True, "Text не Enabled");
                Assert.That(_mainPage.SelectCountryTextClickable, Is.EqualTo("false"), "Text не кликабелен");
        ...
        public void WhenTheUserSelectsGender(string gender)
        {
            ...
            {
                Assert.Fail($"Unknown gender: {gender}");
            }
        }
